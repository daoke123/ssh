#!/bin/sh
# shellcheck shell=dash    SSH端口22345，root密码:123123123默认无法发用密码登录，仅允许密钥登录
set -eu
...
install='ca-certificates apt-transport-https libpam-systemd iptables vim wget curl sudo telnet htop'
upgrade=
kernel_params=
bbr=false
hold=false
